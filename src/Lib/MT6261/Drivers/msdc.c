...
#include "msdc.h"
#include "pll.h"      // PLL_CLK_CONDD
#include "pmu.h"      // VMC_CON0 etc
#include "gpio.h"     // GPIOx definitions / GPIO_Setup
#include "pctl.h"     // PCTL_PowerDown/Up and PD_MSDC2
#include "delay.h"    // delay_ms/us
#include <assert.h>
#include <string.h>    // memset
#include <stdio.h>     // printf

// Backward compatibility: original code used delay_m / delay_u naming.
#ifndef delay_m
#define delay_m(ms) delay_ms(ms)
#endif
#ifndef delay_u
#define delay_u(us) delay_us(us)
#endif
