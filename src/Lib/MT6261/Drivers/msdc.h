...
// Required standard headers for fixed-width types and boolean
#include <stdint.h>
#include <stdbool.h>

// Some structs use uint64_t; ensure <stdint.h> is included before any use.

#define MSDC_base       (0xA0270000) // MS/SD Controller 2 base address
