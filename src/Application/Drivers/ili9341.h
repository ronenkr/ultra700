...
extern void ILI9341_FlushFrameBuffer(void);
extern void ILI9341_UpdateRect(TRECT rect);
extern void ILI9341_DirectPixelWrite(uint16_t x, uint16_t y, uint16_t color);
extern void ILI9341_DrawFilledRect(uint16_t x, uint16_t y, uint16_t width, uint16_t height, uint16_t color);
extern void ILI9341_SetInversion(boolean invert);
